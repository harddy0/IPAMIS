...
<body>
    ...
    <div class="ml-64">
        ...
        <div class="p-10 m-6 mt-10 shadow-xl">
            ...
            <div class="bg-blue-500 p-6 rounded-lg mb-8">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <input type="text" placeholder="EMPLOYEE ID NUMBER" class="p-3 bg-gray-200 rounded text-gray-700">
                    <input type="text" placeholder="USER TYPE" class="p-3 bg-gray-200 rounded text-gray-700">
                    <input type="text" placeholder="FIRST NAME" class="p-3 bg-gray-200 rounded text-gray-700">
                    <input type="text" placeholder="MIDDLE NAME" class="p-3 bg-gray-200 rounded text-gray-700">
                    <input type="text" placeholder="LAST NAME" class="p-3 bg-gray-200 rounded text-gray-700">
                    <input type="text" placeholder="CAMPUS" class="p-3 bg-gray-200 rounded text-gray-700">
                    <input type="text" placeholder="DEPARTMENT" class="p-3 bg-gray-200 rounded text-gray-700">
                    <input type="text" placeholder="CONTACT NUMBER" class="p-3 bg-gray-200 rounded text-gray-700">
                </div>
            </div>
