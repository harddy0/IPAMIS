...
<body>
    ...
    <!-- Main Edit Profile Content Wrapper -->
    <div class="edit-profile-container p-10 m-6 mt-10 shadow-xl">
        ...
        <div class="account-settings grid grid-cols-3 gap-5 mb-8">
            <div class="account-input-group bg-blue-500 p-5 rounded-lg">
                <input type="email" placeholder="EMAIL ADDRESS" class="account-input w-full p-3 bg-gray-200 rounded text-gray-700">
            </div>
            <div class="password-input-group bg-blue-500 p-5 rounded-lg">
