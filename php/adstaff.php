                    ...
                    <table class="w-full bg-gray-100 border-collapse table-fixed">
                        <thead class="bg-blue-800 text-white">
                            <tr>
                                ...
                                <th class="px-4 py-3 border w-2/12 text-left">Department</th>
                                <th class="px-4 py-3 border w-1/12 text-center">Contact#</th>
                        ...
                        <table class="w-full bg-gray-100 border-collapse table-fixed">
                            <tbody>
                                <tr class="hover:bg-blue-50">
                                    ...
                                    <td class="px-4 py-3 border w-2/12 text-left">CCICT</td>
                                    <td class="px-4 py-3 border w-1/12 text-center">09847362832</td>
                                ...
                                <tr class="hover:bg-blue-50">
                                    ...
                                    <td class="px-4 py-3 border w-2/12 text-left">CTU - Main</td>
                                    <td class="px-4 py-3 border w-2/12 text-left">COT</td>
                                    <td class="px-4 py-3 border w-1/12 text-center">09847362832</td>
                                    <td class="px-4 py-3 border w-2/12 text-center">sample@gmail.com</td>
                                    <td class="px-2 py-3 border w-1/12 text-center">
                                        <button class="text-red-500 hover:text-red-700 text-3xl hover:text-xl transition-all duration-200">
                                ...
                                <tr class="hover:bg-blue-50">
                                    ...
                                    <td class="px-4 py-3 border w-1/12 text-left">Admin</td>
                                    <td class="px-4 py-3 border w-2/12 text-left">CTU - Main</td>
                                    <td class="px-4 py-3 border w-2/12 text-left">CME</td>
                                    <td class="px-4 py-3 border w-1/12 text-center">09847362832</td>
                                    <td class="px-4 py-3 border w-2/12 text-center">sample@gmail.com</td>
                                    <td class="px-2 py-3 border w-1/12 text-center">
                                        <button class="text-red-500 hover:text-red-700 text-3xl hover:text-xl transition-all duration-200">
                                ...
                                <tr class="hover:bg-blue-50">
                                    <td class="px-2 py-3 border w-1/12">05</td>
                                    <td class="px-4 py-3 border w-2/12">Mae Jubaihib</td>
                                    <td class="px-4 py-3 border w-1/12">Staff</td>
                                    <td class="px-4 py-3 border w-2/12">CTU - Main</td>
                                    <td class="px-4 py-3 border w-1.5/12">CCICT</td>
                                    <td class="px-4 py-3 border w-1/12 text-center">09847362832</td>
                                    <td class="px-4 py-3 border w-2/12 text-center">sample@gmail.com</td>
                                    <td class="px-2 py-3 border w-1/12 text-center">
                                        <button class="text-red-500 hover:text-red-700 text-3xl hover:text-xl transition-all duration-200">
